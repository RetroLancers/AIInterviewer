...
![](https://github.com/ServiceStack/docs.servicestack.net/blob/main/AIInterviewer/wwwroot/img/pages/templates/vue-spa.webp)
...
![](https://raw.githubusercontent.com/ServiceStack/docs.servicestack.net/refs/heads/main/AIInterviewer/wwwroot/img/pages/templates/info/vite-dev.svg)
...
![](https://raw.githubusercontent.com/ServiceStack/docs.servicestack.net/refs/heads/main/AIInterviewer/wwwroot/img/pages/templates/info/vite-prod.svg)
...
After modifying C# service models, regenerate TypeScript dtos.ts in `AIInterviewer` or `AIInterviewer.Client` with:
...
Create migration classes in `AIInterviewer/Migrations/` following the pattern in `Migration1000.cs`.
...
- **AIInterviewer/appsettings.json** - Application configuration
- **AIInterviewer.Client/next.config.mjs** - Next.js configuration
- **AIInterviewer.Client/styles/index.css** - Tailwind CSS configuration
...
```json
{
  ...
  "SmtpConfig": {
    ...
    "FromName": "AIInterviewer"
  },
  "AppConfig": {
    "BaseUrl": "https://aiinterviewer.example.com"
  }
}
```
...
This will generate an empty `AIInterviewer.ServiceModel/<Table>.d.ts` file along with stub AutoQuery APIs and DB Migration implementations. 
