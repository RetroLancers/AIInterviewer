...
## Checklist
- [x] Extract `OpenAiSchemaGenerator` logic from `OpenAiProvider`.
- [x] Extract `GeminiSchemaGenerator` logic from `GeminiAiProvider`.
- [x] Update `OpenAiProvider` to use `OpenAiSchemaGenerator`.
- [x] Update `GeminiAiProvider` to use `GeminiSchemaGenerator`.
