...
- [Bookings.d.ts](https://github.com/NetCoreTemplates/react-vite/blob/main/AIInterviewer.ServiceModel/Bookings.d.ts)
...
Along with different seed data, tailored for Income and Expenses:
 - [categoryAutoTag.ts](https://github.com/mythz/budgets.apps.cafe/blob/main/AIInterviewer.Client/src/lib/categoryAutoTag.ts)
 
And 19 passing tests to verify a working implementation:
 
 - [categoryAutoTag.test.ts](https://github.com/mythz/budgets.apps.cafe/blob/main/AIInterviewer.Client/src/lib/categoryAutoTag.test.ts)
