...
const project = ref('AIInterviewer')
const projectZip = computed(() => (project.value || 'AIInterviewer') + '.zip')

/** @param {string} template */
const zipUrl = (template:string) =>
    `https://account.servicestack.net/archive/${template}?Name=${project.value || 'AIInterviewer'}`
