...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/AIInterviewer/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/AIInterviewer.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/AIInterviewer/Program.cs):
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/AIInterviewer/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[AIInterviewer.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/AIInterviewer/AIInterviewer.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/AIInterviewer/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/AIInterviewer/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/AIInterviewer/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/AIInterviewer/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/AIInterviewer/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/AIInterviewer/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/AIInterviewer/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/AIInterviewer.ServiceInterface/EmailServices.cs) in a 
